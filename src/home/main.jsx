...
// One entry per game in the library. A game under development can be
// commented out here (and marked "(hidden)" in README.md) while it keeps
// building, so its direct URL under ./games/<slug>/ keeps working.
const GAMES = [
  ...
  { title: 'Tierhopp', description: 'Frosken hopper langs tallinja – trykk der du tror svaret bor, og land sammen med den.', href: './games/tierhopp/', badge: 'Regnespill', art: 'jump' },
];
