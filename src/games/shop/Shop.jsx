...
export const ITEM_BANK = [
  { id: 'apple', name: 'eple', emoji: '🍎', price: 8, category: 'food' },
  { id: 'banana', name: 'banan', emoji: '🍌', price: 6, category: 'food' },
  { id: 'orange', name: 'appelsin', emoji: '🍊', price: 9, category: 'food' },
  { id: 'grapes', name: 'druer', emoji: '🍇', price: 15, category: 'food' },
  { id: 'strawberry', name: 'jordbær', emoji: '🍓', price: 15, category: 'food' },
  { id: 'carrot', name: 'gulrot', emoji: '🥕', price: 7, category: 'food' },
  { id: 'milk', name: 'melk', emoji: '🥛', price: 14, category: 'food' },
  { id: 'juice', name: 'juice', emoji: '🧃', price: 21, category: 'food' },
  { id: 'bread', name: 'brød', emoji: '🍞', price: 23, category: 'food' },
  { id: 'cheese', name: 'ost', emoji: '🧀', price: 25, category: 'food' },
  { id: 'iceCream', name: 'is', emoji: '🍦', price: 25, category: 'food' },
  { id: 'cinnamonBun', name: 'kanelbolle', emoji: '🥐', price: 15, category: 'food' },
  { id: 'chocolate', name: 'sjokolade', emoji: '🍫', price: 24, category: 'food' },
  { id: 'candy', name: 'godteri', emoji: '🍬', price: 3, category: 'food' },
  { id: 'popcorn', name: 'popcorn', emoji: '🍿', price: 20, category: 'food' },
  { id: 'ball', name: 'ball', emoji: '⚽', price: 33, category: 'toys' },
  { id: 'car', name: 'bil', emoji: '🚗', price: 35, category: 'toys' },
  { id: 'train', name: 'tog', emoji: '🚂', price: 42, category: 'toys' },
  { id: 'teddy', name: 'bamse', emoji: '🧸', price: 45, category: 'toys' },
  { id: 'balloon', name: 'ballong', emoji: '🎈', price: 10, category: 'toys' },
  { id: 'kite', name: 'drake', emoji: '🪁', price: 45, category: 'toys' },
  { id: 'plane', name: 'fly', emoji: '✈️', price: 35, category: 'toys' },
  { id: 'helicopter', name: 'helikopter', emoji: '🚁', price: 55, category: 'toys' },
  { id: 'pencil', name: 'blyant', emoji: '✏️', price: 5, category: 'school' },
  { id: 'ruler', name: 'linjal', emoji: '📏', price: 12, category: 'school' },
  { id: 'book', name: 'bok', emoji: '📕', price: 35, category: 'school' },
  { id: 'scissors', name: 'saks', emoji: '✂️', price: 15, category: 'school' },
  { id: 'backpack', name: 'sekk', emoji: '🎒', price: 45, category: 'school' },
  { id: 'crayons', name: 'fargeblyanter', emoji: '🖍️', price: 25, category: 'school' },
  { id: 'donald', name: 'Donald', emoji: '🦆', price: 25, category: 'school' },
  // Machinery and vehicles. Prices follow the same friendly rule:
  // every two-digit ones digit stays 0–5 so the counting stays easy.
  { id: 'boat', name: 'båt', emoji: '🚢', price: 20, category: 'tech' },
  { id: 'rocket', name: 'roket', emoji: '🚀', price: 30, category: 'tech' },
  { id: 'submarine', name: 'ubåt', emoji: '🚤', price: 25, category: 'tech' },
  { id: 'bus', name: 'buss', emoji: '🚌', price: 21, category: 'tech' },
  { id: 'tram', name: 'tram', emoji: '🚋', price: 20, category: 'tech' },
  { id: 'subway', name: 'T-bane', emoji: '🚇', price: 25, category: 'tech' },
  { id: 'truck', name: 'lastebil', emoji: '🚚', price: 42, category: 'tech' },
  { id: 'tractor', name: 'traktor', emoji: '🚜', price: 34, category: 'tech' },
  { id: 'fireEngine', name: 'brannbil', emoji: '🚒', price: 33, category: 'tech' },
  { id: 'ambulance', name: 'ambulanse', emoji: '🚑', price: 30, category: 'tech' },
  { id: 'policeCar', name: 'politibil', emoji: '🚓', price: 42, category: 'tech' },
  { id: 'taxi', name: 'taxi', emoji: '🚕', price: 25, category: 'tech' },
  { id: 'raceCar', name: 'racerbil', emoji: '🏎️', price: 55, category: 'tech' },
  { id: 'scooter', name: 'scooter', emoji: '🛵', price: 30, category: 'tech' },
  { id: 'bicycle', name: 'sykkel', emoji: '🚲', price: 23, category: 'tech' },
  { id: 'sailboat', name: 'seilbåt', emoji: '⛵', price: 30, category: 'tech' },
  { id: 'antenna', name: 'antenne', emoji: '📡', price: 12, category: 'tech' },
  { id: 'magnet', name: 'magnet', emoji: '🧲', price: 35, category: 'tech' },
  { id: 'microscope', name: 'mikroskop', emoji: '🔬', price: 45, category: 'tech' },
  { id: 'compass', name: 'kompass', emoji: '🧭', price: 25, category: 'tech' },
  { id: 'robot', name: 'robot', emoji: '🤖', price: 55, category: 'tech' },
  { id: 'satellite', name: 'satellitt', emoji: '🛰️', price: 45, category: 'tech' },
  { id: 'ufo', name: 'ufo', emoji: '🛸', price: 55, category: 'tech' },
  { id: 'tent', name: 'telt', emoji: '⛺', price: 33, category: 'tech' },
  { id: 'key', name: 'nøkkel', emoji: '🗝️', price: 2, category: 'tech' },
  { id: 'crane', name: 'kran', emoji: '🏗️', price: 40, category: 'tech' },
  { id: 'gem', name: 'edelsten', emoji: '💎', price: 40, category: 'toys' },
];
const PICKS_PER_CATEGORY = { food: 3, toys: 3, school: 2, tech: 7 };
