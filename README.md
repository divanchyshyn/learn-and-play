...
- Butikken (hidden) - trade with the shopkeeper at a split counter: pick up to three goods from the shop shelf, pay by working out the total yourself, watch them land on your own shelf - and return anything you regret to earn the money back while both purses stay honest. Still in development, so it is not shown in the game library, but it is built and reachable at [/games/butikken/](./games/butikken/).
