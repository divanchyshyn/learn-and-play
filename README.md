...
- [Word fishing](./games/word-fishing/) (library title "Ordfiske", hidden) - go fishing for words: tap a fish to bring it up from the pond, hear the word out loud if you like, and fill the bucket at your own pace. Still in development, so it is not shown in the game library, but it is built and reachable at [/games/word-fishing/](./games/word-fishing/).
